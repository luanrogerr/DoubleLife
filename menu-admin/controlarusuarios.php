...
<tr><th>Id</th><th>Nome</th><th>Email</th><th>Senha</th><th>Acesso</th><th>Status</th><th colspan="3">Ações</td></tr>
	...
	<?php
	  while($row = $result->fetch_assoc()) {
		...
		echo "<td>" . $row["id"] . "</td><td>" . $row["nome"] . "</td><td>" . $row["email"] . "</td><td>" . $row["senha"] . "</td><td>" . $row["cpf"] . "</td><td>" . $row["cep"] . "</td><td>" . $row["telefone"] . "</td><td>" . $row["data_nascimento"] . "</td><td>" . $row["tipo"] . "</td><td>" . $row["status"] . "</td>";
		echo "<td><a href='editarusuariosform.php?id=" . $row["id"] . "'><img src='./imagens/editar.png' alt='Editar Usuário'></a></td><td><a href='bloquearusuarios.php?id=" . $row["id"] . "&status=" . $row["status"] . "'><img src='./imagens/bloquear.png' alt='Bloquear Usuário'></a></td><td><a href='excluirusuarios.php?id=" . $row["Id"] . "'><img src='./imagens/excluir.png' alt='Excluir Usuário'></a></td></tr>";
	  }
	?>
...
<div class="pagination">
    ...
    <a href="cadastro-login.php"><img src="./imagens/incluir.png" alt="Incluir Usuário"></a>
    </div>
<div class="footer">
  <p>Projeto Final</p>
</div>
